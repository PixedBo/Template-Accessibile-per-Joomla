        ...
        <div class="container">
          <div class="row">
                ...
                <div class="card-body pb-5 px-0">
                  <div class="category-top">
                    <svg class="icon icon-sm" aria-hidden="true">
                      <use xlink:href="<?= $this->baseurl ?>/templates/<?= $this->template ?>/svg/sprites.svg#it-calendar"></use>
                    </svg>
                    <span class="title-xsmall-semi-bold fw-semibold">Notizie</span>
                    <span class="data fw-normal">18 mag 2022</span>
                  </div>
                  <a href="#" class="text-decoration-none">
                    <h3 class="card-title">Parte l'estate con oltre 300 eventi in centro e nei quartieri, tutti gli eventi previsti
                    </h3>
                  </a>
                  <p class="mb-4 pt-3 lora"><strong>Inaugurazione lunedì 2 luglio</strong> con il concerto
                    gratuito in piazza XX Settembre degli Sweet Soul Music Revue. Sul palco 20 musicisti dal tutto il mondo</p>
                  <a class="chip chip-simple" href="#">
                    <span class="chip-label">Estate in città</span>
                  </a>
                  <a class="read-more pb-3" href="#" data-focus-mouse="false">
                    <span class="text">Tutte le novità</span>
                    <svg class="icon">
                      <use xlink:href="<?= $this->baseurl ?>/templates/<?= $this->template ?>/svg/sprites.svg#it-arrow-right"></use>
                    </svg>
                  </a>
                </div>
              </div>
            ...
            <div class="col-lg-6 order-1 order-lg-2 px-0 px-lg-3">
              <img src="#" title="titolo immagine" alt="descrizione immagine" class="img-fluid">
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="section section-muted pb-90 pb-lg-50 px-lg-5 pt-0">
          <div class="container">
            ...
            <div class="row row-calendar">
              <div class="it-carousel-wrapper it-carousel-landscape-abstract-four-cols it-calendar-wrapper splide splide--slide splide--ltr splide--draggable is-active is-initialized" data-bs-carousel-splide="" id="splide01">
                ...
                <div class="splide__track" id="splide01-track" style="padding-left: 0px; padding-right: 0px;">
                  <ul class="splide__list it-carousel-all" id="splide01-list" style="transform: translateX(0px);">
                    <li class="splide__slide is-active is-visible" id="splide01-slide01" style="width: calc(25%);" tabindex="0" data-focus-mouse="false">
                      <div class="it-single-slide-wrapper h-100">
                        <div class="card-wrapper h-100">
                          <div class="card card-bg">
                            <div class="card-body">
                              <h4 class="card-title pb-4 mb-10 text-secondary">15<span>lun</span></h4>
                              <p class="card-text px-2 pb-10 mb-10"><a href="#">Saldo
                                  TASI</a>
                              </p>
                              <p class="card-text px-2 pb-10 mb-10 d-flex">
                                <img src="#" alt="random image" class="me-3 rounded">
                    ...
                    <li class="splide__slide is-visible is-next" id="splide01-slide02" style="width: calc(25%);" tabindex="0">
                      <div class="it-single-slide-wrapper h-100">
                        <div class="card-wrapper h-100">
                          <div class="card card-bg">
                            <div class="card-body">
                              <h4 class="card-title pb-4 mb-10 text-secondary">16<span>mar</span></h4>
                    ...
                    <li class="splide__slide is-visible" id="splide01-slide03" style="width: calc(25%);" tabindex="0">
                      <div class="it-single-slide-wrapper h-100">
                        <div class="card-wrapper h-100">
                          <div class="card card-bg">
                            <div class="card-body">
                              <h4 class="card-title pb-4 mb-10 text-secondary">17<span>mar</span></h4>
                    ...
                    <li class="splide__slide is-visible" id="splide01-slide04" tabindex="0" style="width: calc(25%);" data-focus-mouse="false">
                      <div class="it-single-slide-wrapper h-100">
                        <div class="card-wrapper h-100">
                          <div class="card card-bg">
                            <div class="card-body">
                              <h4 class="card-title pb-4 mb-10 text-secondary">18<span>mar</span></h4>
                    ...
                    <li class="splide__slide" id="splide01-slide05" style="width: calc(25%);" aria-hidden="true">
                      <div class="it-single-slide-wrapper h-100">
                        <div class="card-wrapper h-100">
                          <div class="card card-bg">
                            <div class="card-body">
                              <h4 class="card-title pb-4 mb-10">19<span>mar</span></h4>
                              <p class="card-text px-2 pb-10 mb-10"><a href="#" tabindex="-1">Saldo
                                  TASI</a>
                              </p>
                              <p class="card-text px-2 pb-10 mb-10 d-flex">
                                <img src="#" alt="random image" class="me-3 rounded">
                                <a href="#" tabindex="-1">Concerto gratuito piazza
                                  XXIV maggio</a>
                              </p>
                              <p class="card-text px-2 pb-10 mb-10"><a href="#" tabindex="-1">Convocazione Consiglio Comunale - Prima
                                  seduta</a></p>
                              <p class="card-text px-2"><a href="#" tabindex="-1">Seconda rata TARI</a></p>
                            </div>
                          </div>
                        </div>
                      </div>
                    </li>
                    <li class="splide__slide" id="splide01-slide06" style="width: calc(25%);" aria-hidden="true">
                      <div class="it-single-slide-wrapper h-100">
                        <div class="card-wrapper h-100">
                          <div class="card card-bg">
                            <div class="card-body">
                              ...
                              <p class="card-text px-2 pb-10 mb-10"><a href="#" tabindex="-1">Convocazione
                                  Consiglio Comunale - Prima seduta</a></p>
                              <p class="card-text px-2"><a href="#" tabindex="-1">Seconda rata TARI</a></p>
                            </div>
                          </div>
                    ...
                    <li class="splide__slide" id="splide01-slide07" style="width: calc(25%);" aria-hidden="true">
              ...
              <ul class="splide__pagination"><li><button class="splide__pagination__page is-active" type="button" aria-controls="splide01-slide01 splide01-slide02 splide01-slide03 splide01-slide04" aria-label="Vai a pagina 1" data-focus-mouse="false" aria-current="true"></button></li><li><button class="splide__pagination__page" type="button" aria-controls="splide01-slide04 splide01-slide05 splide01-slide06 splide01-slide07" aria-label="Vai a pagina 2" data-focus-mouse="false"></button></li></ul></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="container">
            ...
            <div class="row pt-30">
              ...
              <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2 text-center">
                <a href="#" class="btn btn-primary mt-40">Mostra tutti</a>
              </div>
            </div>
            <div class="row pt-5">
              <h2>Siti tematici</h2>
            ...
            <div class="pt-4 pt-lg-30">
              <div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal card-teaser-block-3 pb-0">
                ...
                <a href="#" class="card card-teaser card-bg-warning rounded mt-0 p-3">
                  ...
                  <div class="card-body">
                    <h3 class="card-title sito-tematico">
                      Turismo
                    </h3>
            ...
            <div class="row d-flex justify-content-center">
              <div class="col-12 col-lg-6">
                ...
                <div class="cmp-input-search">
                  <div class="form-group autocomplete-wrapper mb-2 mb-lg-4">
                    <div class="input-group">
                      ...
                      <input type="search" class="autocomplete form-control" placeholder="Cerca una parola chiave" id="autocomplete-autocomplete-three" name="autocomplete-three" data-bs-autocomplete="[]"><ul class="autocomplete-list"></ul>
                ...
                <div class="link-list-wrapper">
                  ...
                  <ul class="link-list">
                    <li>
                      <a class="list-item mb-3 active ps-0" href="#"><span class="text-button-normal">Rilascio Carta
                          Identità Elettronica (CIE)</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class="list-item mb-3 active ps-0" href="#"><span class="text-button-normal">Tributi online</span></a>
                    </li>
                    <li>
                    ...
                    <ul class="contact-list p-0">
                      <li><a class="list-item" href="#">
                          <svg class="icon icon-primary icon-sm" aria-hidden="true">
                            <use href="<?= $this->baseurl ?>/templates/<?= $this->template ?>/svg/sprites.svg#it-help-circle"></use>
                          </svg><span>Leggi le domande frequenti</span></a></li>
              
                      <li><a class="list-item" href="#" data-element="contacts">
                          <svg class="icon icon-primary icon-sm" aria-hidden="true">
                            <use href="<?= $this->baseurl ?>/templates/<?= $this->template ?>/svg/sprites.svg#it-mail"></use>
                          </svg><span>Richiedi assistenza</span></a></li>
              
                      <li><a class="list-item" href="#">
                          <svg class="icon icon-primary icon-sm" aria-hidden="true">
                            <use href="<?= $this->baseurl ?>/templates/<?= $this->template ?>/svg/sprites.svg#it-hearing"></use>
                          </svg><span>Chiama il numero verde 05 0505</span></a></li>
              
                      <li><a class="list-item" href="#" data-element="appointment-booking">
                          <svg class="icon icon-primary icon-sm" aria-hidden="true">
                            <use href="<?= $this->baseurl ?>/templates/<?= $this->template ?>/svg/sprites.svg#it-calendar"></use>
                      ...
                      <ul class="contact-list p-0">
                        <li><a class="list-item" href="#">
                            <svg class="icon icon-primary icon-sm" aria-hidden="true">
                              <use href="<?= $this->baseurl ?>/templates/<?= $this->template ?>/svg/sprites.svg#it-map-marker-circle"></use>
